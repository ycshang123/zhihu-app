<template>
	<div class="container flex-around">
		<div class="left">
			<div class="tab">
				<span><router-link to="/home/recommoned" class="bar_title">推荐</router-link></span>
				<span><router-link to="/home/follow" class="bar_title">关注</router-link></span>
				<span><router-link to="/home/hot" class="bar_title">热榜</router-link></span>
			</div>
			<router-view />
		</div>
		<div class="right">
			<div class="first">
				<div class="item">
					<svg class="gray-icon" viewBox="0 0 24 24" width="24" height="24">
						<path
				...
				<div class="item">
					<svg class="gray-icon" viewBox="0 0 24 24" width="20" height="20">
						<path
			...
			<div class="second flex-around">
				<div class="create flex-around">
					...
					<span class="middle_font">创作者中心</span>
				</div>
				<span class="blue_font">去开通</span>
			</div>
			<div class="first">
				<div class="item">
					<svg  fill="#ffcf00" viewBox="0 0 24 24" width="24" height="24">
						<path
