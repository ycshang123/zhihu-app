		...
		<div class="container row-flex">
			...
			<div class="right">
				...
				<div class="first">
					...
					<div class="item">
						<svg fill="#43d480" viewBox="0 0 24 24" width="24" height="24">
							<path
					...
					<div class="item">
						<svg fill="#0084ff" viewBox="0 0 24 24" width="24" height="24">
							<path
					...
					<div class="item">
						<svg fill="#0f88eb" viewBox="0 0 24 24" width="24" height="24">
							<path
					...
					<div class="item">
						<svg fill="#5478f0" viewBox="0 0 24 24" width="24" height="24">
							<path
					...
					<div class="item">
						<svg fill="#5868d1" viewBox="0 0 24 24" width="24" height="24">
							<path
				...
				<div class="third ">
					<div class="create">
						...
						<span class="middle_font" style="padding-left: 5px;">我的收藏</span>
					</div>
					<div class="create">
						<svg fill="#8590a6" viewBox="0 0 24 24" width="18" height="18">
							<path
						...
						<span class="middle_font" style="padding-left: 5px;">我关注的问题</span>
					</div>
					<div class="create">
						<svg fill="#8590a6" viewBox="0 0 24 24" width="18" height="18">
							<path
						...
						<span class="middle_font"style="padding-left: 5px;">我的邀请</span>
					</div>
					<div class="create ">
						<svg fill="#8590a6" viewBox="0 0 24 24" width="18" height="18">
							<path
						...
						<span class="middle_font" style="padding-left: 5px;">我的余额</span>
					</div>
					<div class="create">
						<svg fill="#8590a6" viewBox="0 0 24 24" width="18" height="18">
							<path
						...
						<span class="middle_font" style="padding-left: 5px;">站务中心</span>
					</div>
					<div class="create">
						<svg fill="#8590a6" viewBox="0 0 24 24" width="18" height="18">
							<path
						...
						<span class="middle_font" style="padding-left: 5px;">版权站务中心</span>
					</div>
				</div>
				<div class="fourth">
					<span class="middle_font" style="padding-bottom: 6px;">刘看山·知乎指南·知乎协议·知乎隐私保护指引</span>
					<span class="middle_font" style="padding-bottom: 6px;">应用·工作·申请开通知乎机构号</span>
					<span class="middle_font" style="padding-bottom: 6px;">侵权举报网上有害信息举报专区</span>
					<span class="middle_font" style="padding-bottom: 6px;">京 ICP 证 110745 号</span>
					<span class="middle_font" style="padding-bottom: 6px;">京 ICP 备 13052560 号 - 1</span>
					<span class="middle_font" style="padding-bottom: 6px;"><img src="https://pic3.zhimg.com/80/v2-d0289dc0a46fc5b15b3363ffa78cf6c7.png">京公网安备 11010802010035 号</span>
					<span class="middle_font" style="padding-bottom: 6px;">互联网药品信息服务资格证书</span>
					<span class="middle_font" style="padding-bottom: 6px;">（京）- 非经营性 - 2017 - 0067</span>
					<span class="middle_font" style="padding-bottom: 6px;">违法和不良信息举报：010-82716601</span>
					<span class="middle_font" style="padding-bottom: 6px;">儿童色情信息举报专区</span>
					<span class="middle_font" style="padding-bottom: 6px;">证照中心</span>
					<span class="middle_font" style="padding-bottom: 6px;">联系我们 © 2020 知乎</span>
				</div>
				<button class="goto-top" @click="backToTop" v-show="btnFlag">
					<svg fill="#8590a6" title="回到顶部" viewBox="0 0 24 24" width="24" height="24">
						<path
