<template>
	<div>
		<div class="nav shadow flex-around" v-if="fixed">
			<div class="box flex-around">
				<svg viewBox="0 0 200 91" class="icon" width="64" height="30" aria-hidden="true" style="height: 30px; width: 64px;">
					<title></title>
					<g>
						<path
				...
				<span><router-link to="/home" class="nomal_font">首页</router-link></span>
				<span><router-link to="/explore" class="nomal_font">发现</router-link></span>
				<span><router-link to="/question/waiting" class="nomal_font">等你来答</router-link></span>
			</div>
			<div class="box flex-center">
				<input type="text" placeholder="劝人喝酒竟有法律风险" class="input_text" />
				<button class="nomal_button bule_bts">提问</button>
			</div>
			<div class="small-box flex-around">
				<svg fill="#8590a6" viewBox="0 0 24 24" width="22" height="22">
					<path
				...
				<span><router-link to="/login" class="nomal_font">去登录</router-link></span>
			</div>
		</div>
		<div class="nav-hid shadow flex-around" v-else>
			<div class="box flex-around">
				<svg viewBox="0 0 200 91" class="icon" width="64" height="30" aria-hidden="true" style="height: 30px; width: 64px;">
					<title></title>
					<g>
				...
				<span><router-link to="/home/recommoned" class="nomal_font">推荐</router-link></span>
				<span><router-link to="/home/follow" class="nomal_font">关注</router-link></span>
				<span><router-link to="/home/hot" class="nomal_font">热榜</router-link></span>
			</div>
			<div class="box flex-center">
				<input type="text" placeholder="搜索你感兴趣的内容" class="input_small_text" />
				<button class="nomal_button bule_bts">提问</button>
			</div>
